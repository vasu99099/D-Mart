...
export const getAddress = async (req, res) => {
  try {
    // const id = "649528774bebbfaf16270f12";
    // const address = await addressModel.find({ user_id: id }).populate('city state');
    const address = await addressModel.find({ user_id: req.body.user_id }).populate('city state');
